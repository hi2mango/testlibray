...
!(function (e, t) {
    ...
    var i = { title: void 0, field: void 0, columns: void 0, visible: void 0, hozAlign: void 0, vertAlign: void 0, width: void 0, minWidth: 40, maxWidth: void 0, maxInitialWidth: void 0, cssClass: void 0, variableHeight: void 0, headerVertical: void 0, headerHozAlign: void 0, headerWordWrap: !1, editableTitle: void 0 };
    class s {
        constructor(e) {
            return (
                (this._cell = e),
    ...
    class b extends e {
        ...
        addRowActual(e, t, i, s) {
            var o,
                n,
                r = e instanceof m ? e : new m(e || {}, this),
        ...
        nextDisplayRow(e, t) {
            var i = this.getDisplayRowIndex(e),
                s = !1;
            return !1 !== i && i < this.displayRowsCount - 1 && (s = this.getDisplayRows()[i + 1]), !s || (s instanceof m && "row" == s.type) ? s : this.nextDisplayRow(s, t);
        }
        prevDisplayRow(e, t) {
            var i = this.getDisplayRowIndex(e),
                s = !1;
            return i && (s = this.getDisplayRows()[i - 1]), !t || !s || (s instanceof m && "row" == s.type) ? s : this.prevDisplayRow(s, t);
        }
        findRowIndex(e, t) {
            var i;
        ...
        refreshActiveData(e, t, i) {
            ...
            if (!this.table.destroyed) {
                ...
                if (this.redrawBlock)
                    return void (
                        (!this.redrawBlockRestoreConfig || (this.redrawBlockRestoreConfig && ((this.redrawBlockRestoreConfig.stage === o && n < this.redrawBlockRestoreConfig.index) || a.indexOf(o) < a.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
                        (this.redrawBlockRestoreConfig = { handler: e, skipStage: t, renderInPosition: i, stage: o, index: n })
                    );
                r.elVisible(this.element) ? (i ? this.reRenderInPosition(this.refreshPipelines.bind(this, e, o, n, i)) : (this.refreshPipelines(e, o, n, i), e || this.table.columnManager.renderer.renderColumns(), this.renderTable(), s.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0))) : this.refreshPipelines(e, o, n, i),
                ...
                if (a && a.target === r) i = a.component;
                    ...
                    switch (e) {
                        ...
                        case "column":
                            ...
                            break;
                        case "cell":
                            s.components.includes("cell") && (o.row instanceof m ? (i = o.row.findCell(r)) : t.row && console.warn("Event Target Lookup Error - The row this cell is attached to cannot be found, has the table been reinitialized without being destroyed first?"));
                    }
    ...
    class x {
        ...
        static lookupTable(e, t) {
            ...
            if ("string" == typeof e) {
                ...
                ("undefined" != typeof HTMLElement && e instanceof HTMLElement) || e instanceof _
        ...
        static matchElement(e) {
            return x.tables.find(function (t) {
                return e instanceof _ ? t === e : t.element === e;
            });
        }
    }
    x.tables = [];
    ...
    class _ {
        ...
        initializeCoreSystems(e) {
            (this.columnManager = new c(this)),
                ...
                (this.alertManager = new F(this)),
                this.bindModules(),
                (this.options = this.optionsList.generate(_.defaultOptions, e)),
        ...
        _loadInitialData() {
            this.dataLoader.load(this.options.data), this.columnManager.verticalAlignHeaders();
        }
        destroy() {
            var e = this.element;
    ...
    class O extends k {
        ...
        lookupAccessor(e) {
            ...
            switch (typeof e) {
                case "string":
                    O.accessors[e] ? (t = O.accessors[e]) : console.warn("Accessor Error - No such accessor found, ignoring: ", e);
                    break;
                case "function":
                    t = e;
            }
    ...
    (O.moduleName = "accessor"), (O.accessors = {});
    function A(e, t) {
        var i = [];
        ...
        else if ("object" == typeof e) for (var s in e) i = i.concat(A(e[s], t ? t + "[" + s + "]" : s));
        ...
        initializeColumn(e) {
            ...
            if (t.topCalc) {
                switch (typeof t.topCalc) {
                    case "string":
                        J.calculations[t.topCalc] ? (i.topCalc = J.calculations[t.topCalc]) : console.warn("Column Calc Error - No such calculation found, ignoring: ", t.topCalc);
                        break;
                    case "function":
                        i.topCalc = t.topCalc;
                }
            ...
            if (t.bottomCalc) {
                switch (typeof t.bottomCalc) {
                    case "string":
                        J.calculations[t.bottomCalc] ? (i.botCalc = J.calculations[t.bottomCalc]) : console.warn("Column Calc Error - No such calculation found, ignoring: ", t.bottomCalc);
                        break;
                    case "function":
    ...
    (J.moduleName = "columnCalcs"), (J.calculations = U);
    class X extends k {
        constructor(e) {
            super(e),
                (this.indent = 10),
        ...
        generateChildren(e) {
            ...
            return (
                Array.isArray(i) || (i = [i]),
                i.forEach((i) => {
                    var s = new m(i || {}, this.table.rowManager);
            ...
            return (
                "object" == typeof e
                    ? e instanceof m
                        ...
                        ? t.modules.dataTree && (i = t.modules.dataTree.children.find((t) => t instanceof m && t.element === e)) && (i = i.data)
                        : null === e && (i = !1)
            ...
            return (
                s &&
                    ...
                    s.children.forEach((e) => {
                        e instanceof m && (o.push(t ? e.getComponent() : e), i && (o = o.concat(this.getTreeChildren(e, t, i))));
                    })),
                o
            );
        }
    ...
    class K extends k {
        ...
        download(e, t, i, s, o) {
            var n = !1;
            if (("function" == typeof e ? (n = e) : K.downloaders[e] ? (n = K.downloaders[e]) : console.warn("Download Error - No such download type found: ", e), n)) {
    ...
    (K.moduleName = "download"), (K.downloaders = q);
    class $ {
                            ...
                            function (t) {
                                if (r.currentCell === e && !h) {
                                    ...
                                    return !0 === i || "highlight" === r.table.options.validationMode
                                        ? ((h = !0), r.clearEditor(), e.modules.edit || (e.modules.edit = {}), (e.modules.edit.edited = !0), -1 == r.editedCells.indexOf(e) && r.editedCells.push(e), e.setValue(t, !0), !0 === i)
                                        : ((h = !0),
                                          (r.invalidEdit = !0),
    ...
    class ie extends k {
        ...
        generateExportList(e, t, i, s) {
            var o, n;
            if (((this.cloneTableStyle = t), (this.config = e || {}), (this.colVisProp = s), "range" === i)) {
                var r = this.table.modules.selectRange.selectedColumns();
                (o = !1 !== this.config.columnHeaders ? this.headersToExportRows(this.generateColumnGroupHeaders(r)) : []), (n = this.bodyToExportRows(this.rowLookup(i), this.table.modules.selectRange.selectedColumns(!0)));
            } else (o = !1 !== this.config.columnHeaders ? this.headersToExportRows(this.generateColumnGroupHeaders()) : []), (n = this.bodyToExportRows(this.rowLookup(i)));
            return o.concat(n);
        }
            ...
            if ("function" == typeof e)
                ...
                switch (e) {
                    ...
                    case "selected":
                        ...
                        break;
                    case "range":
                        t = this.table.modules.selectRange.selectedRows();
                        break;
                    default:
                ...
                e.columns.forEach((o, n) => {
                    if (o) {
                        var r,
                            ...
                            h = this.table,
                            d = h.columnManager.findColumnIndex(l),
                            c = o.value,
                            u = {
                                modules: {},
                                getValue: function () {
                        ...
                        if (
                            ...
                            c = this.table.modules.format.formatExportValue(u, this.colVisProp);
                        else
                            switch (typeof c) {
                                case "object":
                        ...
                        c instanceof Node ? a.appendChild(c) : (a.innerHTML = c),
                            (r = i.styleCells && i.styleCells[d] ? i.styleCells[d] : i.firstCell) &&
                                (this.mapElementStyles(r, a, ["padding-top", "padding-left", "padding-right", "padding-bottom", "border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "text-align"]), l.definition.align && (a.style.textAlign = l.definition.align)),
                            this.table.options.dataTree &&
                                !1 !== this.config.dataTree &&
                                ((t.treeElementField && t.treeElementField == l.field) || (!t.treeElementField && 0 == n)) &&
                                (e.component._row.modules.dataTree.controlEl && a.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), a.firstChild), e.component._row.modules.dataTree.branchEl && a.insertBefore(e.component._row.modules.dataTree.branchEl.cloneNode(!0), a.firstChild)),
                            s.appendChild(a),
    ...
    var ne = {
        ...
        link: function (e, t, i) {
            ...
            if (l) {
                if ((t.urlField && ((s = e.getData()), (o = r.retrieveNestedData(this.table.options.nestedFieldSeparator, t.urlField, s))), t.url))
                    switch (typeof t.url) {
                        case "string":
                            o = t.url;
                            break;
    ...
    class ue extends k {
        ...
        _rebindRow(e, t) {
            this.history.forEach(function (i) {
                if (i.component instanceof m) i.component === e && (i.component = t);
    ...
    (ge.moduleName = "import"), (ge.importers = pe);
    class be extends k {
        constructor(e) {
            super(e),
                (this.eventMap = {
    ...
    class Fe extends k {
        ...
        deprecatedOptionsCheck() {
            this.deprecationCheck("selectable", "selectableRows", !0),
                this.deprecationCheck("selectableRollingSelection", "selectableRowsRollingSelection", !0),
                this.deprecationCheck("selectableRangeMode", "selectableRowsRangeMode", !0),
                this.deprecationCheck("selectablePersistence", "selectableRowsPersistence", !0),
                this.deprecationCheck("selectableCheck", "selectableRowsCheck", !0);
        }
        rowRetrieve(e, t) {
    ...
    var Oe = {
        ...
        date: function (e, t, i, s, o, n, r) {
            return r.format || (r.format = "dd/MM/yyyy"), _e.call(this, e, t, i, s, o, n, r);
        },
        time: function (e, t, i, s, o, n, r) {
            return r.format || (r.format = "HH:mm"), _e.call(this, e, t, i, s, o, n, r);
        },
        datetime: _e,
    ...
    class Ae extends k {
        ...
        initializeColumn(e) {
            ...
            switch (typeof e.definition.sorter) {
                case "string":
                    Ae.sorters[e.definition.sorter] ? (s = Ae.sorters[e.definition.sorter]) : console.warn("Sort Error - No such sorter found: ", e.definition.sorter);
                    break;
                case "function":
    ...
    (Ae.moduleName = "sort"), (Ae.sorters = Oe);
    class Be {
        constructor(e) {
            return (
                (this._range = e),
    ...
    class Ve extends e {
        ...
        layout() {
            var e,
                ...
                o,
                n,
                r = this.table.rowManager.renderer.vDomTop,
                a = this.table.rowManager.renderer.vDomBottom,
                l = this.table.columnManager.renderer.leftCol,
                h = this.table.columnManager.renderer.rightCol;
            null == r && (r = 0),
                null == a && (a = 1 / 0),
                null == l && (l = 0),
                null == h && (h = 1 / 0),
                this.overlaps(l, r, h, a) &&
                    ((e = Math.max(this.top, r)),
                    (t = Math.min(this.bottom, a)),
                    (i = Math.max(this.left, l)),
                    (s = Math.min(this.right, h)),
                    (o = this.rangeManager.getCell(e, i)),
                    (n = this.rangeManager.getCell(t, s)),
                    this.element.classList.add("tabulator-range-active"),
                    (this.element.style.left = o.row.getElement().offsetLeft + o.getElement().offsetLeft + "px"),
                    (this.element.style.top = o.row.getElement().offsetTop + "px"),
                    (this.element.style.width = n.getElement().offsetLeft + n.getElement().offsetWidth - o.getElement().offsetLeft + "px"),
                    (this.element.style.height = n.row.getElement().offsetTop + n.row.getElement().offsetHeight - o.row.getElement().offsetTop + "px"));
        }
        atTopLeft(e) {
    ...
    class Ie extends k {
        ...
        initialize() {
            this.options("selectableRange") && (this.options("selectableRows") ? console.warn("SelectRange functionality cannot be used in conjunction with row selection") : ((this.maxRanges = this.options("selectableRange")), this.initializeTable(), this.initializeWatchers()));
        }
        initializeTable() {
        ...
        handleColumnMouseDown(e, t) {
            (2 !== e.button || ("column" !== this.selecting && "all" !== this.selecting) || !this.activeRange.occupiesColumn(t)) && ((this.mousedown = !0), document.addEventListener("mouseup", this.mouseUpEvent), this.newSelection(e, t));
        }
        ...
        navigate(e, t, i) {
            ...
            return (
                ...
                s
                    ? ((l = this.getRowByRangePos(o.end.row)),
        ...
        findJumpCellLeft(e, t) {
            ...
            return a && (n = a.column.getPosition() - 1), n;
        }
        findJumpCellRight(e, t) {
            ...
            return r && (n = r.column.getPosition() - 1), n;
        }
        findJumpCellUp(e, t) {
        ...
        layoutRanges() {
            ...
            this.table.initialized &&
                ...
                ((this.activeRangeCellElement.style.left = e.row.getElement().offsetLeft + e.getElement().offsetLeft + "px"),
                (this.activeRangeCellElement.style.top = e.row.getElement().offsetTop + "px"),
                (this.activeRangeCellElement.style.width = e.getElement().offsetLeft + e.getElement().offsetWidth - e.getElement().offsetLeft + "px"),
                (this.activeRangeCellElement.style.height = e.row.getElement().offsetTop + e.row.getElement().offsetHeight - e.row.getElement().offsetTop + "px"),
        ...
        resetRanges() {
            var e, t;
            return this.ranges.forEach((e) => e.destroy()), (this.ranges = []), (e = this.addRange()), this.table.rowManager.activeRows.length && (t = this.table.rowManager.activeRows[0].cells[this.rowHeader ? 1 : 0]) && (e.setBounds(t), this.initializeFocus(t)), e;
        }
        tableDestroyed() {
    ...
    class je extends k {
        ...
        _buildValidator(e, t) {
            var i = "function" == typeof e ? e : je.validators[e];
    ...
    (je.moduleName = "validate"), (je.validators = We);
