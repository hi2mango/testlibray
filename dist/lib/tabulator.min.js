...
!(function (e, t) {
    ...
    class n extends t {
        ...
        _configureCell() {
            ...
            this.column.vertAlign && ((e.style.display = "inline-flex"), (e.style.alignItems = { top: "flex-start", bottom: "flex-end", middle: "center" }[this.column.vertAlign] || ""), this.column.hozAlign && (e.style.justifyContent = { left: "flex-start", right: "flex-end", center: "center" }[this.column.hozAlign] || "")),
    ...
    class r extends t {
        ...
        matchChildWidths() {
            ...
            this.contentElement &&
                ...
                this.table.initialized && (this.element.style.width = e + "px"),
                this.parent.isGroup && this.parent.matchChildWidths());
        }
        removeChild(e) {
                ...
                this.table.columnManager.columnsByIndex.forEach((e) => {
                    ...
                    e.visible &&
                        (e.modules.frozen ||
                            ...
                            s + t > this.vDomScrollPosLeft && s < this.vDomScrollPosRight ? (-1 == this.leftCol && ((this.leftCol = this.columns.length), (this.vDomPadLeft = s)), (this.rightCol = this.columns.length)) : -1 !== this.leftCol && (this.vDomPadRight += t),
                            this.columns.push(e),
                            (e.modules.vdomHoz = i),
                            (s += t)));
                }),
    ...
    class b extends h {
        ...
        scrollRows(e, t) {
            ...
            if (((this.scrollTop = e), -i > o || s > o)) {
                ...
                t
                    ? (i < 0 && this._addTopRow(n, -i), s < 0 && (this.vDomScrollHeight - this.scrollTop > this.vDomWindowBuffer ? this._removeBottomRow(n, -s) : (this.vDomScrollPosBottom = this.scrollTop)))
                    : (s >= 0 && this._addBottomRow(n, s), i >= 0 && (this.scrollTop > this.vDomWindowBuffer ? this._removeTopRow(n, i) : (this.vDomScrollPosTop = this.scrollTop)));
        }
        resize() {
        ...
        _virtualRenderFill(e, t, i) {
            ...
            if (g && a.elVisible(this.elementVertical)) {
                ...
                (e
                    ? ((this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - u), (this.vDomBottomPad = this.vDomBottom == g - 1 ? 0 : Math.max(this.vDomScrollHeight - this.vDomTopPad - h - u, 0)))
                    : ((this.vDomTopPad = 0), (this.vDomRowHeight = Math.floor((h + u) / v)), (this.vDomBottomPad = this.vDomRowHeight * (g - this.vDomBottom - 1)), (this.vDomScrollHeight = u + h + this.vDomBottomPad - E)),
                ...
                if (this.vDomTop) {
                    ...
                    d && r < this.vDomMaxRenderChain
                        ? ((l = d.getHeight() || this.vDomRowHeight),
                          (h = d.initialized),
                          t >= l ? (this.styleRow(d, n), i.insertBefore(d.getElement(), i.firstChild), (d.initialized && d.heightInitialized) || s.push(d), d.initialize(), h || ((l = d.getElement().offsetHeight), l > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * l)), (t -= l), (o += l), this.vDomTop--, n--, r++) : (a = !1))
                        : (a = !1);
                } else a = !1;
        ...
        _addBottomRow(e, t) {
            for (var i = this.tableElement, s = [], o = 0, n = this.vDomBottom + 1, r = 0, a = !0; a; ) {
                ...
                d && r < this.vDomMaxRenderChain
                    ? ((l = d.getHeight() || this.vDomRowHeight),
                      (h = d.initialized),
                      t >= l ? (this.styleRow(d, n), i.appendChild(d.getElement()), (d.initialized && d.heightInitialized) || s.push(d), d.initialize(), h || ((l = d.getElement().offsetHeight), l > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * l)), (t -= l), (o += l), this.vDomBottom++, n++, r++) : (a = !1))
                    : (a = !1);
            }
            for (let e of s) e.clearCellHeight();
    ...
    class f extends t {
        ...
        refreshActiveData(e, t, i) {
            ...
            if (!this.table.destroyed) {
                ...
                if (this.redrawBlock)
                    return void (
                        (!this.redrawBlockRestoreConfig || (this.redrawBlockRestoreConfig && ((this.redrawBlockRestoreConfig.stage === o && n < this.redrawBlockRestoreConfig.index) || r.indexOf(o) < r.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
                        (this.redrawBlockRestoreConfig = { handler: e, skipStage: t, renderInPosition: i, stage: o, index: n })
                    );
                (a.elVisible(this.element) ? (i ? this.reRenderInPosition(this.refreshPipelines.bind(this, e, o, n, i)) : (this.refreshPipelines(e, o, n, i), e || this.table.columnManager.renderer.renderColumns(), this.renderTable(), s.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0))) : this.refreshPipelines(e, o, n, i),
        ...
        restoreRedraw() {
            ((this.redrawBlock = !1),
                this.redrawBlockRestoreConfig ? (this.refreshActiveData(this.redrawBlockRestoreConfig.handler, this.redrawBlockRestoreConfig.skipStage, this.redrawBlockRestoreConfig.renderInPosition), (this.redrawBlockRestoreConfig = !1)) : this.redrawBlockRenderInPosition && this.reRenderInPosition(),
                (this.redrawBlockRenderInPosition = !1));
        }
        redraw(e) {
    ...
    class x extends t {
        ...
        check(e, t, i) {
            ...
            return (
                ...
                ((s = "Deprecated Setup Option - Use of the %c" + e + "%c option is now deprecated"),
                t ? ((s = s + ", Please use the %c" + t + "%c option instead"), this._warnUser(s, "font-weight: bold;", "font-weight: normal;", "font-weight: bold;", "font-weight: normal;"), i && (this.table.options[t] = this.table.options[e])) : this._warnUser(s, "font-weight: bold;", "font-weight: normal;"),
                !1)
            );
        }
        checkMsg(e, t) {
    ...
    let k = class e extends t {
        ...
        _lookupContainer() {
            ...
            return (
                "string" == typeof e ? (e = document.querySelector(e)) || console.warn("Menu Error - no container element found matching selector:", this.table.options.popupContainer, "(defaulting to document body)") : !0 === e && (e = this.table.element),
    ...
    var S = {
        ...
        fitDataStretch: function (e, t) {
            ...
            (e.forEach((e, t) => {
                ...
                n
                    ? ((o = s - i + n.getWidth()), this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && (n.setWidth(0), this.table.modules.responsiveLayout.update()), o > 0 ? n.setWidth(o) : n.reinitializeWidth())
                    : this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update());
        },
                    ...
                    e.forEach(function (e, n) {
                        ...
                        e.column.minWidth >= r
                            ...
                            : e.column.maxWidth && e.column.maxWidth < r
                              ...
                              : (p.push(e), (c += s ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1));
                    }),
                    o.length
    ...
    var z = {
        default: {
            ...
            pagination: { page_size: "Page Size", page_title: "Show Page", first: "First", first_title: "First Page", last: "Last", last_title: "Last Page", prev: "Prev", prev_title: "Prev Page", next: "Next", next_title: "Next Page", all: "All", counter: { showing: "Showing", of: "of", rows: "rows", pages: "pages" } },
        ...
        static registry = {
            ...
            lookupTable(e, t) {
                var i,
                    ...
                    o = [];
                if ("string" == typeof e) {
                    if ((i = document.querySelectorAll(e)).length) for (var n = 0; n < i.length; n++) (s = H.registry.matchElement(i[n])) && o.push(s);
                } else
                    ("undefined" != typeof HTMLElement && e instanceof HTMLElement) || e instanceof H
                        ? (s = H.registry.matchElement(e)) && o.push(s)
                        : Array.isArray(e)
                          ? e.forEach(function (e) {
            ...
            matchElement: (e) =>
                H.registry.tables.find(function (t) {
    ...
    class _ extends H {
        ...
        static _registerModuleExtensions(e) {
            ...
            if (e.moduleExtensions)
                for (let e in t) {
                    let i = t[e];
                    if (_.moduleBindings[e]) for (let t in i) _._extendModule(e, t, i[t]);
                    else {
    ...
    class A extends _ {
        ...
        constructor(e, t, i) {
            (super(),
                ...
                (this.dependencyRegistry = new T(this)),
                (this.initialized = !1),
                (this.destroyed = !1),
        ...
        initializeCoreSystems(e) {
            ((this.columnManager = new u(this)),
                ...
                (this.alertManager = new O(this)),
                this._bindModules(),
                (this.options = this.optionsList.generate(A.defaultOptions, e)),
    ...
    function N(e, t) {
        ...
        else if ("object" == typeof e) for (var s in e) i = i.concat(N(e[s], t ? t + "[" + s + "]" : s));
    ...
    function U(e, t) {
        ...
        else if ("object" == typeof e) for (var s in e) i = i.concat(U(e[s], t ? t + "[" + s + "]" : s));
        else i.push({ key: t, value: e });
        return i;
    }
    var J = {
    ...
    class X extends M {
        ...
        static defaultConfig = I;
        static defaultURLGenerator = j;
        static defaultLoaderPromise = G;
        static contentTypeFormatters = J;
        constructor(e) {
            (super(e),
                (this.config = {}),
                (this.url = ""),
    ...
    class $ extends M {
        ...
        static moduleExtensions = Y;
        static pasteActions = q;
        static pasteParsers = K;
        constructor(e) {
            (super(e),
                (this.mode = !0),
    ...
    class ee extends M {
        ...
        generateRow(e, t) {
            ...
            return (
                ...
                (i.component = !1),
                (i.getComponent = () => (i.component || (i.component = new Q(i)), i.component)),
                (i.generateCells = () => {
                    var t = [];
                    (this.table.columnManager.columnsByIndex.forEach((s) => {
                        (this.genColumn.setField(s.getField()),
                            ...
                            s.definition[e + "CalcFormatter"] && this.table.modExists("format")
                                ? (this.genColumn.modules.format = { formatter: this.table.modules.format.lookupFormatter(s.definition[e + "CalcFormatter"]), params: s.definition[e + "CalcFormatterParams"] || {} })
                                : (this.genColumn.modules.format = { formatter: this.table.modules.format.lookupFormatter("plaintext"), params: {} }),
    ...
    var te = {
        ...
        pdf: function (e, t = {}, i) {
            var s,
                ...
                r = [],
                a = {},
                l = t.rowGroupStyles || { fontStyle: "bold", fontSize: 12, cellPadding: 6, fillColor: 220 },
                h = t.rowCalcStyles || { fontStyle: "bold", fontSize: 10, cellPadding: 4, fillColor: 232 },
                d = t.jsPDF || {},
                c = t.title ? t.title : "";
            function u(e, t) {
                var i = [];
            ...
            (d.orientation || (d.orientation = t.orientation || "landscape"),
                d.unit || (d.unit = "pt"),
                e.forEach((e) => {
                    switch (e.type) {
                        case "header":
                ...
                (s = this.dependencyRegistry.lookup("jspdf", "jsPDF")),
                (o = new s(d)),
                t.autoTable && (a = "function" == typeof t.autoTable ? t.autoTable(o) || {} : t.autoTable),
                c &&
                    (a.didDrawPage = function (e) {
                        o.text(c, 40, 30);
                    }),
                (a.head = n),
                (a.body = r),
                o.autoTable(a),
                t.documentProcessing && t.documentProcessing(o),
                i(o.output("arraybuffer"), "application/pdf"));
        },
        xlsx: function (e, i, s) {
            var o = i.sheetName || "Sheet1",
                ...
                h = i.writeOptions || { bookType: "xlsx", bookSST: !0, compression: l };
            function d() {
                var t = [],
                    i = [],
                    s = {},
                ...
                return (
                    ...
                    n.utils.sheet_add_aoa(s, t),
                    (s["!ref"] = n.utils.encode_range(o)),
                    i.length && (s["!merges"] = i),
                    s
                );
            }
            if (((h.type = "binary"), (r.SheetNames = []), (r.Sheets = {}), i.sheetOnly)) s(d());
            else {
                if (i.sheets)
                    for (var c in i.sheets)
                        !0 === i.sheets[c]
                            ? (r.SheetNames.push(c), (r.Sheets[c] = d()))
                            : (r.SheetNames.push(c),
                              a.commsSend(i.sheets[c], "download", "intercept", {
                                  type: "xlsx",
                                  options: { sheetOnly: !0 },
                                  active: this.active,
                ...
                (i.documentProcessing && (r = i.documentProcessing(r)),
                    s(
                        (function (e) {
        ...
        triggerDownload(e, t, i, s, o) {
            ...
            r &&
                (o
                    ...
                    : ((s = s || "Tabulator." + ("function" == typeof i ? "txt" : i)), navigator.msSaveOrOpenBlob ? navigator.msSaveOrOpenBlob(r, s) : (n.setAttribute("href", window.URL.createObjectURL(r)), n.setAttribute("download", s), (n.style.display = "none"), document.body.appendChild(n), n.click(), document.body.removeChild(n))),
    ...
    let oe = class {
        ...
        _createInputElement() {
            ...
            if ((t.setAttribute("type", this.params.clearable ? "search" : "text"), (t.style.padding = "4px"), (t.style.width = "100%"), (t.style.boxSizing = "border-box"), this.params.autocomplete || ((t.style.cursor = "default"), (t.style.caretColor = "transparent")), e && "object" == typeof e))
        ...
        _ajaxRequest(e, t) {
            return (
                (e = j(e, {}, this.params.filterRemote ? { term: t } : {})),
                fetch(e)
            ...
            return (
                (t = e ? this.table.columnManager.getColumnByField(e) : this.cell.getColumn()._getSelf())
                    ? s.forEach((e) => {
                          ...
                          this._emptyValueCheck(s) ||
                              (this.params.multiselect && Array.isArray(s)
                                  ? s.forEach((e) => {
        ...
        _chooseItem(e, t) {
            ...
            ((this.typing = !1),
                this.params.multiselect
                    ? ((i = this.currentItems.indexOf(e)) > -1 ? (this.currentItems.splice(i, 1), (e.selected = !1)) : (this.currentItems.push(e), (e.selected = !0)), (this.input.value = this.currentItems.map((e) => e.label).join(",")), this._styleItem(e))
    ...
    var ne = {
        ...
        textarea: function (e, t, i, s, o) {
            var n = e.getValue(),
                ...
                h = 0;
            if (((l.style.display = "block"), (l.style.padding = "2px"), (l.style.height = "100%"), (l.style.width = "100%"), (l.style.boxSizing = "border-box"), (l.style.whiteSpace = "pre-wrap"), (l.style.resize = "none"), o.elementAttributes && "object" == typeof o.elementAttributes))
        ...
        date: function (e, t, i, s, o) {
            ...
            if (((h.type = "date"), (h.style.padding = "4px"), (h.style.width = "100%"), (h.style.boxSizing = "border-box"), o.max && h.setAttribute("max", n ? d(o.max) : o.max), o.min && h.setAttribute("min", n ? d(o.min) : o.min), o.elementAttributes && "object" == typeof o.elementAttributes))
        ...
        time: function (e, t, i, s, o) {
            ...
            if (((d.type = "time"), (d.style.padding = "4px"), (d.style.width = "100%"), (d.style.boxSizing = "border-box"), o.elementAttributes && "object" == typeof o.elementAttributes))
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), d.setAttribute(e, d.getAttribute(e) + o.elementAttributes["+" + e])) : d.setAttribute(e, o.elementAttributes[e]);
            function c() {
                var e,
                    t = d.value;
                if ((null == h && "" !== t) || t !== h) {
        ...
        datetime: function (e, t, i, s, o) {
            var n,
                ...
                h = e.getValue(),
                d = document.createElement("input");
            if (((d.type = "datetime-local"), (d.style.padding = "4px"), (d.style.width = "100%"), (d.style.boxSizing = "border-box"), o.elementAttributes && "object" == typeof o.elementAttributes))
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), d.setAttribute(e, d.getAttribute(e) + o.elementAttributes["+" + e])) : d.setAttribute(e, o.elementAttributes[e]);
            function c() {
                var e,
                    t = d.value;
                ...
                d.forEach(function (t, i) {
                    i < e
                        ? ("ie" == n.table.browser ? t.setAttribute("class", "tabulator-star-active") : t.classList.replace("tabulator-star-inactive", "tabulator-star-active"),
                          (t.innerHTML = '<polygon fill="#488CE9" stroke="#014AAE" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>'))
        ...
        adaptable: function (e, t, i, s, o) {
            ...
            return (
                ...
                o.paramsLookup && (r = "function" == typeof o.paramsLookup ? o.paramsLookup(n, e) : o.paramsLookup[n]),
                this.table.modules.edit.lookupEditor(n, a).call(this, e, t, i, s, r || {})
            );
        },
    };
    class re extends M {
    ...
    class ce extends M {
        ...
        static columnLookups = he;
        static rowLookups = de;
        constructor(e) {
        ...
        generateExportList(e, t, i, s) {
            ...
            return (
                ...
                (a = ce.columnLookups[i]) && (r = (r = a.call(this.table)).filter((e) => this.columnVisCheck(e))),
        ...
        rowLookup(e) {
            ...
            return (
                "function" == typeof e
                    ...
                    : ((t = ce.rowLookups[e] || ce.rowLookups.active), (i = t.call(this.table))),
                Object.assign([], i)
            );
        }
                    ...
                    if (o) {
                        ...
                        (u instanceof Node ? l.appendChild(u) : (l.innerHTML = u),
                            ...
                            this.table.options.dataTree &&
                                ...
                                ((t.treeElementField && t.treeElementField == h.field) || (!t.treeElementField && 0 == n)) &&
                                (e.component._row.modules.dataTree.controlEl && l.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), l.firstChild), e.component._row.modules.dataTree.branchEl && l.insertBefore(e.component._row.modules.dataTree.branchEl.cloneNode(!0), l.firstChild)),
                            s.appendChild(l),
                    ...
                    if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
                        if (((e.modules.filter.prevSuccess = t), e.modules.filter.emptyFunc(t))) delete i.headerFilters[s];
                            ...
                            switch (((e.modules.filter.value = t), typeof e.definition.headerFilterFunc)) {
                                case "string":
                                    me.filters[e.definition.headerFilterFunc]
    ...
    var pe = {
        ...
        adaptable: function (e, t, i) {
            ...
            return (
                ...
                t.paramsLookup && (o = "function" == typeof t.paramsLookup ? t.paramsLookup(s, e) : t.paramsLookup[s]),
                this.table.modules.format.lookupFormatter(s).call(this, e, o || {}, i)
            );
        },
    ...
    class ge extends M {
        ...
        initializeColumn(e) {
            ((e.modules.format = this.lookupTypeFormatter(e, "")),
                void 0 !== e.definition.formatterPrint && (e.modules.format.print = this.lookupTypeFormatter(e, "Print")),
                void 0 !== e.definition.formatterClipboard && (e.modules.format.clipboard = this.lookupTypeFormatter(e, "Clipboard")),
                void 0 !== e.definition.formatterHtmlOutput && (e.modules.format.htmlOutput = this.lookupTypeFormatter(e, "HtmlOutput")));
        }
        ...
        formatHeader(e, t, i) {
            ...
            return e.definition.titleFormatter
                ? ((s = this.lookupFormatter(e.definition.titleFormatter)),
                  (n = (t) => {
        ...
        removeRow(e) {
            ...
            (t > -1 && this.rows.splice(t, 1),
                this.groupManager.table.options.groupValues || this.rows.length
                    ? (i.parentNode && i.parentNode.removeChild(i), this.groupManager.blockRedraw || (this.generateGroupHeaderContents(), this.groupManager.table.modExists("columnCalcs") && "table" != this.groupManager.table.options.columnCalcs && this.groupManager.table.modules.columnCalcs.recalcGroup(this)))
    ...
    class Re extends M {
        ...
        transformHeader(e) {
            var t = [];
            return this.table.options.importHeaderTransform
                ? (e.forEach((i) => {
        ...
        transformData(e) {
            var t = [];
            return this.table.options.importValueTransform
                ? (e.forEach((i) => {
        ...
        structureArrayToColumns(e) {
            ...
            return (
                s[0] && i[0] && s[0].getDefinition().title === i[0] && e.shift(),
                e.forEach((e) => {
                    var i = {};
    ...
    var xe = { navPrev: "shift + 9", navNext: 9, navUp: 38, navDown: 40, navLeft: 37, navRight: 39, scrollPageUp: 33, scrollPageDown: 34, scrollToStart: 36, scrollToEnd: 35 },
        Te = {
            keyBlock: function (e) {
    ...
    class ke extends M {
        ...
        mapBinding(e, t) {
            var i = { action: ke.actions[e], keys: [], ctrl: !1, shift: !1, meta: !1 };
            t.toString()
                .toLowerCase()
                .split(" ")
                .join("")
        ...
        initializeGroupHeader(e) {
            ...
            ((i.mouseup = function (i) {
                ...
                (i.mousemove = function (i) {
                    var s;
                    i.pageY - a.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2
    ...
    class Fe extends M {
        ...
        constructor(e) {
            (super(e),
                ...
                this.registerTableOption("paginationOutOfRange", !1),
                        ...
                        (this.table.options.paginationCounterElement
                            ? this.table.options.paginationCounterElement instanceof HTMLElement
                                ...
                                : "string" == typeof this.table.options.paginationCounterElement &&
                                  ((i = document.querySelector(this.table.options.paginationCounterElement)) ? i.appendChild(this.pageCounterElement) : console.warn("Pagination Error - Unable to find element matching paginationCounterElement selector:", this.table.options.paginationCounterElement))
                ...
                ((this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie"),
                    this.table.options.persistenceReaderFunc
                        ? "function" == typeof this.table.options.persistenceReaderFunc
                            ...
                            : Oe.readers[this.table.options.persistenceReaderFunc]
                              ? (this.readFunc = Oe.readers[this.table.options.persistenceReaderFunc])
                              : console.warn("Persistence Read Error - invalid reader set", this.table.options.persistenceReaderFunc)
                        : Oe.readers[this.mode]
                          ? (this.readFunc = Oe.readers[this.mode])
                          : console.warn("Persistence Read Error - invalid reader set", this.mode),
                    this.table.options.persistenceWriterFunc
                        ? "function" == typeof this.table.options.persistenceWriterFunc
                            ? (this.writeFunc = this.table.options.persistenceWriterFunc)
                            : Oe.writers[this.table.options.persistenceWriterFunc]
                              ? (this.writeFunc = Oe.writers[this.table.options.persistenceWriterFunc])
                              : console.warn("Persistence Write Error - invalid reader set", this.table.options.persistenceWriterFunc)
                        : Oe.writers[this.mode]
                          ? (this.writeFunc = Oe.writers[this.mode])
                    ...
                    this.config.page &&
                        ...
                        (void 0 === e.paginationSize || (!0 !== this.config.page && !this.config.page.size) || (this.table.options.paginationSize = e.paginationSize), void 0 === e.paginationInitialPage || (!0 !== this.config.page && !this.config.page.page) || (this.table.options.paginationInitialPage = e.paginationInitialPage)),
                    this.config.group &&
    ...
    class Ie extends t {
        ...
        _updateMinMax() {
            ((this.top = Math.min(this.start.row, this.end.row)),
                ...
                this.initialized ? this.dispatchExternal("rangeChanged", this.getComponent()) : this.initializing.start && this.initializing.end && ((this.initialized = !0), this.dispatchExternal("rangeAdded", this.getComponent())));
        }
        _getTableColumns() {
            ...
            if (
                ...
                if (Array.isArray(t))
                    return "string" === h
                        ? String(m(e))
                              .toLowerCase()
                              .localeCompare(String(m(t)).toLowerCase())
                        : m(t) - m(e);
                c = 1;
                    ...
                    ("icon" === this.table.options.headerSortClickElement ? i : t).addEventListener("click", (t) => {
                        ...
                        if (e.modules.sort) {
                            ...
                            (this.table.options.columnHeaderSortMulti && (t.shiftKey || t.ctrlKey)
                                ? ((o = (s = this.getSort()).findIndex((t) => t.field === e.getField())), o > -1 ? ((s[o].dir = i), (o = s.splice(o, 1)[0]), "none" != i && s.push(o)) : "none" != i && s.push({ column: e, dir: i }), this.setSort(s))
                                : "none" == i
                                  ? this.clear()
                                  : this.setSort(e, i),
                                this.refreshSort());
    ...
    class Xe extends t {
        constructor(e, t) {
            (super(e.table),
                ...
                (this.element = null),
                (this.isActive = !1),
                (this.grid = new Ue(this.columnCount, this.rowCount)),
        ...
        load() {
            ...
            ((this.isActive = !0),
                ...
                this.table.restoreRedraw(),
                e && null !== this.scrollTop && ((this.table.rowManager.element.scrollLeft = this.scrollLeft), (this.table.rowManager.element.scrollTop = this.scrollTop)),
    ...
    var Ye = Object.freeze({
                ...
                if (this.table.options.dataTree) {
                    ...
                    switch (
                        ...
                        t.dataTreeCollapseElement
                            ...
                            : ((this.collapseEl = document.createElement("div")), this.collapseEl.classList.add("tabulator-data-tree-control"), (this.collapseEl.tabIndex = 0), (this.collapseEl.innerHTML = "<div class='tabulator-data-tree-control-collapse'></div>")),
                        t.dataTreeExpandElement
                            ...
                            : ((this.expandEl = document.createElement("div")), this.expandEl.classList.add("tabulator-data-tree-control"), (this.expandEl.tabIndex = 0), (this.expandEl.innerHTML = "<div class='tabulator-data-tree-control-expand'></div>")),
                    ...
                    i.index &&
                        (this.branchEl
                            ? ((i.branchEl = this.branchEl.cloneNode(!0)),
                              ...
                              this.table.rtl ? (i.branchEl.style.marginRight = (i.branchEl.offsetWidth + i.branchEl.style.marginLeft) * (i.index - 1) + i.index * this.indent + "px") : (i.branchEl.style.marginLeft = (i.branchEl.offsetWidth + i.branchEl.style.marginRight) * (i.index - 1) + i.index * this.indent + "px"))
                            : this.table.rtl
        ...
        InteractionModule: class extends M {
            ...
            subscribeTouchEvents(e) {
                ...
                (this.touchSubscribers[t + "-touchstart"] ||
                    ((this.touchSubscribers[t + "-touchstart"] = this.handleTouch.bind(this, t, "start")), (this.touchSubscribers[t + "-touchend"] = this.handleTouch.bind(this, t, "end")), this.subscribe(t + "-touchstart", this.touchSubscribers[t + "-touchstart"]), this.subscribe(t + "-touchend", this.touchSubscribers[t + "-touchend"])),
        ...
        MenuModule: class extends M {
            ...
            initializeColumn(e) {
                ...
                (t.headerContextMenu &&
                    ...
                    ((this.columnSubscribers.headerContextMenu = this.loadMenuTableColumnEvent.bind(this, "headerContextMenu")), this.subscribe("column-contextmenu", this.columnSubscribers.headerContextMenu), this.table.on("headerTapHold", this.loadMenuTableColumnEvent.bind(this, "headerContextMenu"))),
                ...
                (e.modules.frozen ||
                    ...
                    (s.mousemove = function (s) {
                        e.parent === i.moving.parent &&
                            ((i.touchMove ? s.touches[0].pageX : s.pageX) - a.elOffset(t).left + i.table.columnManager.contentsElement.scrollLeft > e.getWidth() / 2
        ...
        PopupModule: class extends M {
            ...
            initializeColumn(e) {
                ...
                (t.headerContextPopup &&
                    ...
                    ((this.columnSubscribers.headerContextPopup = this.loadPopupTableColumnEvent.bind(this, "headerContextPopup")), this.subscribe("column-contextmenu", this.columnSubscribers.headerContextPopup), this.table.on("headerTapHold", this.loadPopupTableColumnEvent.bind(this, "headerContextPopup"))),
        ...
        PrintModule: class extends M {
            ...
            initialize() {
                (this.table.options.printAsHtml &&
                    ((this.beforeprintEventHandler = this.replaceTable.bind(this)), (this.afterprintEventHandler = this.cleanup.bind(this)), window.addEventListener("beforeprint", this.beforeprintEventHandler), window.addEventListener("afterprint", this.afterprintEventHandler), this.subscribe("table-destroy", this.destroy.bind(this))),
        ...
        SelectRangeModule: class extends M {
            ...
            constructor(e) {
                (super(e),
                    ...
                    this.registerTableOption("selectableRangeAutoFocus", !0),
            ...
            updateHeaderColumn() {
                ...
                (this.rowSelection &&
                    ...
                    this.table.modules.frozenColumns &&
                        this.table.modules.frozenColumns.active &&
                        ((e = this.table.modules.frozenColumns.getFrozenColumns()).length > 1 || (1 === e.length && e[0] !== this.rowHeader)) &&
            ...
            handleColumnMouseDown(e, t) {
                (2 !== e.button || ("column" !== this.selecting && "all" !== this.selecting) || !this.activeRange.occupiesColumn(t)) &&
                    ((this.table.options.movableColumns && "column" === this.selecting && this.activeRange.occupiesColumn(t)) || ((this.mousedown = !0), document.addEventListener("mouseup", this.mouseUpEvent), this.newSelection(e, t)));
            }
            ...
            navigate(e, t, i) {
                ...
                if ((this.ranges.length > 1 && (this.ranges = this.ranges.filter((e) => (e === this.activeRange ? (e.setEnd(e.start.row, e.start.col), !0) : (e.destroy(), !1)))), (n = { top: (s = this.activeRange).top, bottom: s.bottom, left: s.left, right: s.right }), (r = (o = t ? s.end : s.start).row), (a = o.col), e))
                    switch (i) {
                        case "left":
                ...
                return (
                    ...
                    n.top !== s.top || n.bottom !== s.bottom || n.left !== s.left || n.right !== s.right
                        ? ((l = this.getRowByRangePos(s.end.row)),
                          (h = this.getColumnByRangePos(s.end.col)),
                          (d = l.getElement().getBoundingClientRect()),
                          (u = h.getElement().getBoundingClientRect()),
                          (c = this.table.rowManager.getElement().getBoundingClientRect()),
                          (m = this.table.columnManager.getElement().getBoundingClientRect()),
                          (d.top >= c.top && d.bottom <= c.bottom) || (l.getElement().parentNode && h.getElement().parentNode ? this.autoScroll(s, l.getElement(), h.getElement()) : l.getComponent().scrollTo(void 0, !1)),
                          (u.left >= m.left + this.getRowHeaderWidth() && u.right <= m.right) || (l.getElement().parentNode && h.getElement().parentNode ? this.autoScroll(s, l.getElement(), h.getElement()) : h.getComponent().scrollTo(void 0, !1)),
                          this.layoutElement(),
                          !0)
                        : void 0
                );
            ...
            autoScroll(e, t, i) {
                ...
                (void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()),
                    ...
                    (s = { left: i.offsetLeft, right: i.offsetLeft + i.offsetWidth, top: t.offsetTop, bottom: t.offsetTop + t.offsetHeight }),
                    (n = (o = { left: r.scrollLeft + this.getRowHeaderWidth(), right: Math.ceil(r.scrollLeft + r.clientWidth), top: r.scrollTop, bottom: r.scrollTop + r.offsetHeight - this.table.rowManager.scrollbarWidth }).top < s.top && s.top < o.bottom && o.top < s.bottom && s.bottom < o.bottom),
                    (o.left < s.left && s.left < o.right && o.left < s.right && s.right < o.right) || (s.left < o.left ? (r.scrollLeft = s.left - this.getRowHeaderWidth()) : s.right > o.right && (r.scrollLeft = Math.min(s.right - r.clientWidth, s.left - this.getRowHeaderWidth()))),
                    n || (s.top < o.top ? (r.scrollTop = s.top) : s.bottom > o.bottom && (r.scrollTop = s.bottom - r.clientHeight)));
            }
            layoutChange() {
            ...
            resetRanges() {
                var e, t, i;
                return (
                    this.ranges.forEach((e) => e.destroy()),
                    (this.ranges = []),
                    (e = this.addRange()),
                    this.table.rowManager.activeRows.length && ((i = this.table.rowManager.activeRows[0].cells.filter((e) => e.column.visible)), (t = i[this.rowHeader ? 1 : 0]) && (e.setBounds(t), this.options("selectableRangeAutoFocus") && this.initializeFocus(t))),
                    e
                );
            }
            tableDestroyed() {
        ...
        SelectRowModule: class extends M {
            ...
            initialize() {
                (this.deprecatedOptionsCheck(),
                    ...
                    !1 !== this.table.options.selectableRows &&
                        (this.subscribe("row-init", this.initializeRow.bind(this)),
        ...
        SpreadsheetModule: class extends M {
            ...
            loadRemoteData(e, t, i) {
                return (
                    console.log("data", e, t, i),
                    Array.isArray(e)
                        ? (this.table.dataLoader.clearAlert(), this.dispatchExternal("dataLoaded", e), !e.length || Array.isArray(e[0]) ? this.loadData(e) : this.loadSheets(e))
