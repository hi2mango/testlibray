...
!(function (a) {
    ...
    if (!a.jstree) {
        ...
        !j &&
            ...
            (a.jstree = { version: "3.3.12", defaults: { plugins: [] }, plugins: {}, path: h && -1 !== h.indexOf("/") ? h.replace(/\/[^\/]+$/, "") : "", idregex: /[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g, root: "#" }),
            ...
            (a.jstree.core.prototype = {
                                ...
                                if (c.length && c[0].id !== b && c[0].parent !== b) {
                                    ...
                                    for (p = 0, q = c.length; q > p; p++)
                                        l[c[p].parent.toString()]
                                            ...
                                            : "undefined" != typeof h && ((h._data.core.last_error = { error: "parse", plugin: "core", id: "core_07", reason: "Node with invalid parent", data: JSON.stringify({ id: c[p].id.toString(), parent: c[p].parent.toString() }) }), h.settings.core.error.call(h, h._data.core.last_error));
                ...
                _redraw: function () {
                    ...
                    this._model.force_full_redraw && ((c.className = this.get_container_ul()[0].className), c.setAttribute("role", "group"), this.element.empty().append(c)),
                        null !== g && this.settings.core.restore_focus && ((d = this.get_node(g, !0)), d && d.length && d.children(".jstree-anchor")[0] !== i.activeElement ? d.children(".jstree-anchor").trigger("focus") : (this._data.core.focused = null)),
                ...
                redraw_node: function (b, c, d, e) {
                    ...
                    for (
                        f.a_attr.id || (f.a_attr.id = f.id + "_anchor"),
                            ...
                            this.settings.core.compute_elements_positions && (b.childNodes[1].setAttribute("aria-setsize", p[f.parent].children.length), b.childNodes[1].setAttribute("aria-posinset", p[f.parent].children.indexOf(f.id) + 1)),
                    ...
                    f.state.hidden && (n += " jstree-hidden"),
                        ...
                        f.state.loaded && !v ? (n += " jstree-leaf") : ((n += f.state.opened && f.state.loaded ? " jstree-open" : " jstree-closed"), b.childNodes[1].setAttribute("aria-expanded", f.state.opened && f.state.loaded)),
                                      ...
                                      ? ((h = this.get_node(c, !0)),
                                        ...
                                        h.length &&
                                            ...
                                            e
                                                ...
                                                : (this.trigger("before_open", { node: c }), (h[0].className = h[0].className.replace("jstree-closed", "jstree-open")), h[0].childNodes[1].setAttribute("aria-expanded", !0))),
                                        (c.state.opened = !0),
                                        d && d.call(this, c, !0),
                                ...
                                : ((d = d === b ? this.settings.core.animation : d),
                                  ...
                                  void (h.length
                                      ? d
                                          ...
                                          : ((h[0].className = h[0].className.replace("jstree-open", "jstree-closed")), h.children(".jstree-anchor").attr("aria-expanded", !1), h.children(".jstree-children").remove(), this.trigger("after_close", { node: c }))
                ...
                deselect_all: function (a) {
                    ...
                    (this._data.core.selected = []), this.element.find(".jstree-clicked").removeClass("jstree-clicked").attr("aria-selected", !1), this.trigger("deselect_all", { selected: this._data.core.selected, node: b }), a || this.trigger("changed", { action: "deselect_all", selected: this._data.core.selected, old_selection: b });
                },
                ...
                get_json: function (b, c, d) {
                    ...
                    c && c.flat && !d && (d = []);
                    var e = { id: b.id, text: b.text, icon: this.get_icon(b), li_attr: a.extend(!0, {}, b.li_attr), a_attr: a.extend(!0, {}, b.a_attr), state: {}, data: c && c.no_data ? !1 : a.extend(!0, a.vakata.is_array(b.data) ? [] : {}, b.data) },
                        f,
                        g;
                ...
                delete_node: function (b) {
                    ...
                    return (
                        -1 !== a.inArray(this._data.core.focused, g) &&
                            ...
                            e.id === a.jstree.root ? this._model.data[a.jstree.root].children[0] && this.get_node(this._model.data[a.jstree.root].children[0], !0).children(".jstree-anchor").triger("focus") : this.get_node(e, !0).children(".jstree-anchor").trigger("focus"),
                ...
                check: function (b, c, d, e, f) {
                    ...
                    if ("move_node" === b || "copy_node" === b) {
                        ...
                        if (!((f && f.is_multi) || (c.id !== d.id && ("move_node" !== b || a.inArray(c.id, d.children) !== e) && -1 === a.inArray(d.id, c.children_d))))
                            return (this._data.core.last_error = { error: "check", plugin: "core", id: "core_01", reason: "Moving parent inside child", data: JSON.stringify({ chk: b, pos: e, obj: c && c.id ? c.id : !1, par: d && d.id ? d.id : !1 }) }), !1;
                    }
                    return (
                        g && g.data && (g = g.data),
        ...
        (l.className = "jstree-icon jstree-checkbox"),
            ...
            (a.jstree.plugins.checkbox = function (c, d) {
                (this.bind = function () {
                    ...
                    (this.disable_checkbox = function (b) {
                        ...
                        return (
                            (b = this.get_node(b)), b && b.id !== a.jstree.root ? ((e = this.get_node(b, !0)), void (b.state.checkbox_disabled || ((b.state.checkbox_disabled = !0), e && e.length && e.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-checkbox-disabled"), this.trigger("disable_checkbox", { node: b })))) : !1
                        );
                    }),
                    (this.enable_checkbox = function (b) {
                        ...
                        return (
                            (b = this.get_node(b)), b && b.id !== a.jstree.root ? ((e = this.get_node(b, !0)), void (b.state.checkbox_disabled && ((b.state.checkbox_disabled = !1), e && e.length && e.children(".jstree-anchor").children(".jstree-checkbox").removeClass("jstree-checkbox-disabled"), this.trigger("enable_checkbox", { node: b })))) : !1
                        );
                    }),
                    ...
                    (this.check_node = function (b, c) {
                        ...
                        return (
                            (b = this.get_node(b)),
                            b && b.id !== a.jstree.root ? ((d = this.get_node(b, !0)), void (b.state.checked || ((b.state.checked = !0), this._data.checkbox.selected.push(b.id), d && d.length && d.children(".jstree-anchor").addClass("jstree-checked"), this.trigger("check_node", { node: b, selected: this._data.checkbox.selected, event: c })))) : !1
                        );
                    }),
                    (this.uncheck_node = function (b, c) {
                        ...
                        return (
                            ...
                            b && b.id !== a.jstree.root
                                ? ((f = this.get_node(b, !0)),
                                  void (b.state.checked && ((b.state.checked = !1), (this._data.checkbox.selected = a.vakata.array_remove_item(this._data.checkbox.selected, b.id)), f.length && f.children(".jstree-anchor").removeClass("jstree-checked"), this.trigger("uncheck_node", { node: b, selected: this._data.checkbox.selected, event: c }))))
                                : !1
                        );
                    }),
            ...
            (function (a) {
                ...
                (a.vakata.context = {
                    ...
                    _execute: function (b) {
                        return (b = c.items[b]), b && (!b._disabled || (a.vakata.is_function(b._disabled) && !b._disabled({ item: b, reference: c.reference, element: c.element }))) && b.action ? b.action.call(null, { item: b, reference: c.reference, element: c.element, position: { x: c.position_x, y: c.position_y } }) : !1;
                    },
                    _parse: function (b, d) {
                        if (!b) return !1;
                        d || ((c.html = ""), (c.items = []));
                        ...
                        return (
                            ...
                            a.each(b, function (b, d) {
                                return d
                                    ? (c.items.push(d),
                                      !f && d.separator_before && (e += "<li class='vakata-context-separator'><a href='#' " + (a.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>"),
                                      (f = !1),
                                      (e += "<li class='" + (d._class || "") + (d._disabled === !0 || (a.vakata.is_function(d._disabled) && d._disabled({ item: d, reference: c.reference, element: c.element })) ? " vakata-contextmenu-disabled " : "") + "' " + (d.shortcut ? " data-shortcut='" + d.shortcut + "' " : "") + ">"),
                                      ...
                                      (e += (a.vakata.is_function(d.label) ? d.label({ item: b, reference: c.reference, element: c.element }) : d.label) + (d.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + d.shortcut + '">' + (d.shortcut_label || "") + "</span>" : "") + "</a>"),
                                      d.submenu && ((g = a.vakata.context._parse(d.submenu, !0)), g && (e += g)),
                                      (e += "</li>"),
                                      void (d.separator_after && ((e += "<li class='vakata-context-separator'><a href='#' " + (a.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>"), (f = !0))))
                                    : !0;
                            }),
                                ...
                                .on("mouseenter", "li", function (b) {
                                    b.stopImmediatePropagation(),
                                        a.contains(this, b.relatedTarget) ||
                                            (d && clearTimeout(d), c.element.find(".vakata-context-hover").removeClass("vakata-context-hover").end(), a(this).siblings().find("ul").hide().end().end().parentsUntil(".vakata-context", "li").addBack().addClass("vakata-context-hover"), a.vakata.context._show_submenu(this));
                                })
                        ...
                        this.element.on(
                            ...
                            function (b) {
                                ...
                                if (
                                    ...
                                    c && c.id && c.id !== a.jstree.root && (1 === b.which || "touchstart" === b.type || "dragstart" === b.type) && (this.settings.dnd.is_draggable === !0 || (a.vakata.is_function(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, d > 1 ? this.get_top_selected(!0) : [c], b))))
                                ) {
                                    if (((m = { jstree: !0, origin: this, obj: this.get_node(c, !0), nodes: d > 1 ? this.get_top_selected() : [c.id] }), (n = b.currentTarget), !this.settings.dnd.use_html5))
                                        return (
                                            ...
                                            a.vakata.dnd.start(
                                                b,
                                                m,
                                                '<div id="jstree-dnd" class="jstree-' + this.get_theme() + " jstree-" + this.get_theme() + "-" + this.get_theme_variant() + " " + (this.settings.core.themes.responsive ? " jstree-dnd-responsive" : "") + '"><i class="jstree-icon jstree-er"></i>' + e + '<ins class="jstree-copy">+</ins></div>'
                                            )
                                        );
                                ...
                                if (
                                                    ...
                                                    if (
                                                        ...
                                                        (v =
                                                            ...
                                                            ((k && k.settings && k.settings.dnd && k.settings.dnd.check_while_dragging === !1) ||
                                                                k.check(y, i.data.origin && i.data.origin !== k ? i.data.origin.get_node(i.data.nodes[w]) : i.data.nodes[w], s, z, { dnd: !0, ref: k.get_node(l.parent()), pos: e, origin: i.data.origin, is_multi: i.data.origin && i.data.origin !== k, is_foreign: !i.data.origin }))),
                                                        !v)
                                                    ) {
                                    ...
                                    for (v = !0, w = 0, x = i.data.nodes.length; x > w; w++)
                                        if (
                                            ((v =
                                                v &&
                                                k.check(i.data.origin && (i.data.origin.settings.dnd.always_copy || (i.data.origin.settings.dnd.copy && (i.event.metaKey || i.event.ctrlKey))) ? "copy_node" : "move_node", i.data.origin && i.data.origin !== k ? i.data.origin.get_node(i.data.nodes[w]) : i.data.nodes[w], a.jstree.root, "last", {
                                                    dnd: !0,
                        ...
                        (h = a.vakata.dnd._get()),
                            h &&
                                ...
                                ("keyup" === b.type && 27 === b.which
                                    ...
                                    : (h.helper.find(".jstree-copy").first()[h.data.origin && (h.data.origin.settings.dnd.always_copy || (h.data.origin.settings.dnd.copy && (b.metaKey || b.ctrlKey))) ? "show" : "hide"](), e && ((e.metaKey = b.metaKey), (e.ctrlKey = b.ctrlKey), a.vakata.dnd._trigger("move", e))));
                    });
            }),
            (function (a) {
                a.vakata.html = {
                ...
                a.vakata.dnd = {
                    ...
                    start: function (b, d, e) {
                        "touchstart" === b.type &&
                            ...
                            b.originalEvent.changedTouches &&
                            b.originalEvent.changedTouches[0] &&
                            ((b.pageX = b.originalEvent.changedTouches[0].pageX), (b.pageY = b.originalEvent.changedTouches[0].pageY), (b.target = i.elementFromPoint(b.originalEvent.changedTouches[0].pageX - window.pageXOffset, b.originalEvent.changedTouches[0].pageY - window.pageYOffset))),
                                ...
                                function (b, c) {
                                    if (this._data.search.som && c.res.length) {
                                        ...
                                        for (e = 0, f = c.res.length; f > e; e++)
                                            if (d[c.res[e]] && !d[c.res[e]].state.hidden && (g.push(c.res[e]), (g = g.concat(d[c.res[e]].parents)), this._data.search.smc)) for (h = 0, i = d[c.res[e]].children_d.length; i > h; h++) d[d[c.res[e]].children_d[h]] && !d[d[c.res[e]].children_d[h]].state.hidden && g.push(d[c.res[e]].children_d[h]);
            ...
            (a.jstree.plugins.types = function (c, d) {
                (this.init = function (c, e) {
                    ...
                    (this.get_json = function (b, c, e) {
                        ...
                        if (j === !1) return !1;
                        if (a.vakata.is_array(j)) for (f = 0, g = j.length; g > f; f++) (j[f].type = j[f].id && h[j[f].id] && h[j[f].id].type ? h[j[f].id].type : "default"), c && c.no_id && (delete j[f].id, j[f].li_attr && j[f].li_attr.id && delete j[f].li_attr.id, j[f].a_attr && j[f].a_attr.id && delete j[f].a_attr.id);
                    ...
                    switch ((j || (h = h.toLowerCase()), k && (h = h.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), b)) {
                        ...
                        case "rename_node":
                            return (
                                ...
                                m || (this._data.core.last_error = { error: "check", plugin: "unique", id: "unique_01", reason: "Child with name " + h + " already exists. Preventing: " + b, data: JSON.stringify({ chk: b, pos: f, obj: c && c.id ? c.id : !1, par: e && e.id ? e.id : !1 }) }),
                                m
                            );
                        case "create_node":
                        ...
                        case "move_node":
                            return (
                                ...
                                m || (this._data.core.last_error = { error: "check", plugin: "unique", id: "unique_03", reason: "Child with name " + h + " already exists. Preventing: " + b, data: JSON.stringify({ chk: b, pos: f, obj: c && c.id ? c.id : !1, par: e && e.id ? e.id : !1 }) }),
                                m
                            );
                    }
                    return !0;
