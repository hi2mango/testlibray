!(function (t, e) {
    ...
    class t {
        constructor(t) {
            (t || (t = {}),
                (this.main = t.main || "ss-main"),
                (this.placeholder = t.placeholder || "ss-placeholder"),
                (this.values = t.values || "ss-values"),
                (this.single = t.single || "ss-single"),
                (this.max = t.max || "ss-max"),
                (this.value = t.value || "ss-value"),
                (this.valueText = t.valueText || "ss-value-text"),
                (this.valueDelete = t.valueDelete || "ss-value-delete"),
                (this.valueOut = t.valueOut || "ss-value-out"),
                (this.deselect = t.deselect || "ss-deselect"),
                (this.deselectPath = t.deselectPath || "M10,10 L90,90 M10,90 L90,10"),
                (this.arrow = t.arrow || "ss-arrow"),
                (this.arrowClose = t.arrowClose || "M10,30 L50,70 L90,30"),
                (this.arrowOpen = t.arrowOpen || "M10,70 L50,30 L90,70"),
                (this.content = t.content || "ss-content"),
                (this.openAbove = t.openAbove || "ss-open-above"),
                (this.openBelow = t.openBelow || "ss-open-below"),
                (this.search = t.search || "ss-search"),
                (this.searchHighlighter = t.searchHighlighter || "ss-search-highlight"),
                (this.searching = t.searching || "ss-searching"),
                (this.addable = t.addable || "ss-addable"),
                (this.addablePath = t.addablePath || "M50,10 L50,90 M10,50 L90,50"),
                (this.list = t.list || "ss-list"),
                (this.optgroup = t.optgroup || "ss-optgroup"),
                (this.optgroupLabel = t.optgroupLabel || "ss-optgroup-label"),
                (this.optgroupLabelText = t.optgroupLabelText || "ss-optgroup-label-text"),
                (this.optgroupActions = t.optgroupActions || "ss-optgroup-actions"),
                (this.optgroupSelectAll = t.optgroupSelectAll || "ss-selectall"),
                (this.optgroupSelectAllBox = t.optgroupSelectAllBox || "M60,10 L10,10 L10,90 L90,90 L90,50"),
                (this.optgroupSelectAllCheck = t.optgroupSelectAllCheck || "M30,45 L50,70 L90,10"),
                (this.optgroupClosable = t.optgroupClosable || "ss-closable"),
                (this.option = t.option || "ss-option"),
                (this.optionDelete = t.optionDelete || "M10,10 L90,90 M10,90 L90,10"),
                (this.highlighted = t.highlighted || "ss-highlighted"),
                (this.open = t.open || "ss-open"),
                (this.close = t.close || "ss-close"),
                (this.selected = t.selected || "ss-selected"),
                (this.error = t.error || "ss-error"),
                (this.disabled = t.disabled || "ss-disabled"),
                (this.hide = t.hide || "ss-hide"));
        }
    }
    function e() {
    ...
    class o {
        ...
        updateClassStyles() {
            if (
                ...
                "" !== this.settings.style && ((this.main.main.style.cssText = this.settings.style), (this.content.main.style.cssText = this.settings.style)),
        ...
        mainDiv() {
            ...
            return (h.setAttribute("d", this.classes.arrowClose), this.settings.alwaysOpen && o.classList.add(this.classes.hide), o.appendChild(h), e.appendChild(o), { main: e, values: s, deselect: { main: i, svg: a, path: l }, arrow: { main: o, path: h } });
        }
        mainFocus(t) {
        ...
        searchDiv() {
            ...
            if (
                (this.settings.showSearch || (t.classList.add(this.classes.hide), (e.readOnly = !0)),
                (e.type = "search"),
                    ...
                    (i.onclick = (t) => {
                        ...
                        !1 !== i &&
                            ...
                            (i instanceof Promise
                                ? i.then((t) => {
                                      "string" == typeof t ? s({ text: t, value: t }) : i instanceof Error ? this.renderError(i.message) : s(t);
                                  })
                                : "string" == typeof i
                                  ? s({ text: i, value: i })
                                  : i instanceof Error
        ...
        renderOptions(t) {
            ...
            if (this.settings.allowDeselect && !this.settings.isMultiple) {
                this.store.filter((t) => t.placeholder, !1).length || this.store.addOption(new a({ text: "", value: "", selected: !1, placeholder: !0 }), !0);
            }
            for (const e of t) {
                if (e instanceof n) {
                    const t = document.createElement("div");
                    ...
                    if ("off" !== e.closable) {
                        ...
                        const l = document.createElementNS("http://www.w3.org/2000/svg", "path");
                        (a.appendChild(l),
                            e.options.some((t) => t.selected) || "" !== this.content.search.input.value.trim()
                                ? (i.classList.add(this.classes.open), l.setAttribute("d", this.classes.arrowOpen))
                                : "open" === e.closable
                                  ? (t.classList.add(this.classes.open), l.setAttribute("d", this.classes.arrowOpen))
                                  : "close" === e.closable && (t.classList.add(this.classes.close), l.setAttribute("d", this.classes.arrowClose)),
                            s.addEventListener("click", (e) => {
                                (e.preventDefault(),
                                    e.stopPropagation(),
                                    t.classList.contains(this.classes.close) ? (t.classList.remove(this.classes.close), t.classList.add(this.classes.open), l.setAttribute("d", this.classes.arrowOpen)) : (t.classList.remove(this.classes.open), t.classList.add(this.classes.close), l.setAttribute("d", this.classes.arrowClose)));
                            }),
                            n.appendChild(i));
                    }
                    t.appendChild(s);
        ...
        option(t) {
            ...
            return (
                ...
                this.settings.searchHighlight && "" !== this.content.search.input.value.trim() ? (e.innerHTML = this.highlightText("" !== t.html ? t.html : t.text, this.content.search.input.value, this.classes.searchHighlighter)) : "" !== t.html ? (e.innerHTML = t.html) : (e.textContent = t.text),
                this.settings.showOptionTooltips && e.textContent && e.setAttribute("title", e.textContent),
                t.display || e.classList.add(this.classes.hide),
                t.disabled && e.classList.add(this.classes.disabled),
                t.selected && this.settings.hideSelected && e.classList.add(this.classes.hide),
                t.selected ? (e.classList.add(this.classes.selected), e.setAttribute("aria-selected", "true"), this.main.main.setAttribute("aria-activedescendant", e.id)) : (e.classList.remove(this.classes.selected), e.setAttribute("aria-selected", "false")),
                e.addEventListener("click", (e) => {
                    ...
                    let o = [];
                    (this.settings.isMultiple && (o = t.selected ? l.filter((t) => t.id !== n) : l.concat(t)),
    ...
    class h {
        ...
        changeListen(t) {
            ((this.listen = t), t && this.observer && this.observer.observe(this.select, { subtree: !0, childList: !0, attributes: !0 }), t || (this.observer && this.observer.disconnect()));
        }
        valueChange(t) {
        ...
        getDataFromOptgroup(t) {
            let e = { id: t.id, label: t.label, selectAll: !!t.dataset && "true" === t.dataset.selectall, selectAllText: t.dataset ? t.dataset.selectalltext : "Select all", closable: t.dataset ? t.dataset.closable : "off", options: [] };
    ...
    class c {
        constructor(t) {
            ((this.id = ""),
                ...
                (this.placeholderText = void 0 !== t.placeholderText ? t.placeholderText : "Select Value"),
    ...
    return class {
        constructor(e) {
            var i;
            if (
                ((this.events = { search: void 0, searchFilter: (t, e) => -1 !== t.text.toLowerCase().indexOf(e.toLowerCase()), addable: void 0, beforeChange: void 0, afterChange: void 0, beforeOpen: void 0, afterOpen: void 0, beforeClose: void 0, afterClose: void 0 }),
                (this.windowResize = s(() => {
                ...
                (this.selectEl = "string" == typeof e.select ? document.querySelector(e.select) : e.select),
                !this.selectEl)
            )
            ...
            ((this.settings.disabled = (null === (i = e.settings) || void 0 === i ? void 0 : i.disabled) ? e.settings.disabled : this.selectEl.disabled),
                ...
                (this.store = new l(this.settings.isMultiple ? "multiple" : "single", e.data ? e.data : this.select.getData())),
                e.data && this.select.updateOptions(this.store.getData()));
            const a = { open: this.open.bind(this), close: this.close.bind(this), addable: this.events.addable ? this.events.addable : void 0, setSelected: this.setSelected.bind(this), addOption: this.addOption.bind(this), search: this.search.bind(this), beforeChange: this.events.beforeChange, afterChange: this.events.afterChange };
        ...
        setSelected(t, e = !0) {
            ...
            for (const e of t)
                ...
                else for (const t of n.filter((t) => t.value == e)) a.push(t.id);
        ...
        open() {
            this.settings.disabled ||
                ...
                "absolute" === this.settings.contentPosition && (this.settings.intervalMove && clearInterval(this.settings.intervalMove), (this.settings.intervalMove = setInterval(this.render.moveContent.bind(this.render), 500))));
        }
        close(t = null) {
            this.settings.isOpen &&
